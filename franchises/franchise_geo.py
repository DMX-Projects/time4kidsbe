...
_CITY_QUERY_EQUIVALENTS: dict[str, tuple[str, ...]] = {
    ...
    # West Bengal — geonames leftovers / legacy spellings
    "kolkata": ("kolkata", "calcutta"),
    "calcutta": ("kolkata", "calcutta"),
    "howrah": ("howrah", "haora"),
    "haora": ("howrah", "haora"),
    "hooghly": ("hooghly", "huglichunchura", "hugli-chinsurah", "hugli chinsurah"),
    "siliguri": ("siliguri", "shiliguri"),
    "shiliguri": ("siliguri", "shiliguri"),
    "darjeeling": ("darjeeling", "darjiling"),
    "darjiling": ("darjeeling", "darjiling"),
    "bardhaman": ("bardhaman", "barddhaman", "burdwan"),
    "cooch behar": ("cooch behar", "koch bihar"),

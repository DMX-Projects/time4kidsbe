...
from .views import AdminEventViewSet, EventMediaListCreateView, FranchiseEventViewSet, ParentEventListView, PublicEventListView
...
urlpatterns = router.urls + [
    path("franchise/<int:event_id>/media/", EventMediaListCreateView.as_view(), name="event-media"),

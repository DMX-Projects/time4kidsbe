...
def city_match_variants(city: str) -> list[str]:
    ...
    aliases = {
        ...
        # Meta Instant Form city dropdown → CRM sheet district
        "kochi": ("Ernakulam", "Kochi", "Cochin"),
        "cochin": ("Ernakulam", "Kochi", "Cochin"),
        "ernakulam": ("Ernakulam", "Kochi", "Cochin"),
        "north_paravur": ("Ernakulam", "North Paravur"),
        "north paravur": ("Ernakulam", "North Paravur"),
        "kothamangalam": ("Ernakulam", "Kothamangalam"),
        "muvattupuzha": ("Ernakulam", "Muvattupuzha"),
        "angamaly": ("Ernakulam", "Angamaly"),
        "guruvayur": ("Thrissur", "Guruvayur"),
        "irinjalakuda": ("Thrissur", "Irinjalakuda"),
        "chalakudy": ("Thrissur", "Chalakudy"),
        "kodungallur": ("Thrissur", "Kodungallur"),
        "kalpetta": ("Wayanad", "Kalpetta"),
        "sulthan_bathery": ("Wayanad", "Sulthan Bathery"),
        "sulthan bathery": ("Wayanad", "Sulthan Bathery"),
        "wayanad": ("Wayanad", "Kalpetta"),
